...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[url('https://images.unsplash.com/photo-1582719508461-905c673771fd?ixlib=rb-4.0.3&auto=format&fit=crop&w=2050&q=80')] bg-cover bg-center relative">
      ...
      <div className="bg-paper shadow-2xl w-full max-w-md relative z-10 border-t-4 border-gold fade-in-up overflow-hidden">
        <div className="p-10">
            ...
            <p className="text-slate-500 font-serif italic mt-2">Resort & Spa Management</p>
            </div>
